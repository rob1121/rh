...
},{"_process":70}],75:[function(require,module,exports){
...
},{"vue":74,"vue-hot-reload-api":71,"vueify/lib/insert-css":75}],77:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
...
},{"vue":74,"vue-hot-reload-api":71,"vueify/lib/insert-css":75}],78:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
...
exports.default = {
	...
	mixins: [_pagination2.default, _helper2.default],
	...
	methods: {
		...
		alertMsg: function alertMsg(alert, alertClass) {
			var _this2 = this;

			this.alert.messages = (typeof alert === "undefined" ? "undefined" : (0, _typeof3.default)(alert)) == 'object' ? alert : JSON.parse(alert);

			this.alert.class = alertClass;
			this.show_loader = false;

			setTimeout(function () {
				return _this2.alert.messages = [];
			}, 15000);
		}
	}
};
...
},{"../mixins/helper":81,"../mixins/pagination":82,"babel-runtime/helpers/typeof":3,"vue":74,"vue-hot-reload-api":71,"vueify/lib/insert-css":75}],79:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
...
exports.default = {
    ...
    watch: {
        toggleDropDown: function toggleDropDown(value) {
            ...
            if (value == true) setTimeout(function () {
                return self.toggleDropDown = false;
            }, 10000);
        }
    }
};
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "<div class=\"export\"><label for=\"toggle-drop-down\"><i class=\"fa fa-gear\"></i></label><input id=\"toggle-drop-down\" type=\"checkbox\" v-model=\"toggleDropDown\"/><slot></slot></div>"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  module.hot.dispose(function () {
    __vueify_insert__.cache[".export {\n  position: absolute;\n  right: 0;\n  top: 0;\n  z-index: 2;\n  padding: 10px;\n}\n.export label[for=\"toggle-drop-down\"] {\n  cursor: pointer;\n  float: right;\n  font-weight: bold;\n  color: #999;\n  -webkit-transition: all 0.3s ease-in-out;\n  transition: all 0.3s ease-in-out;\n}\n.export label[for=\"toggle-drop-down\"]:hover {\n  color: #333;\n}\n#toggle-drop-down {\n  opacity: 0;\n}\n#toggle-drop-down:checked + .dropdown-box>.dropdown {\n  opacity: 1;\n  top: 0;\n}\n"] = false
    document.head.removeChild(__vueify_style__)
  })
  if (!module.hot.data) {
    hotAPI.createRecord("_v-d8d4ac9e", module.exports)
  } else {
    hotAPI.update("_v-d8d4ac9e", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"vue":74,"vue-hot-reload-api":71,"vueify/lib/insert-css":75}],80:[function(require,module,exports){
'use strict';
...
},{"../components/toggleGear.vue":79}],81:[function(require,module,exports){
"use strict";
...
exports.default = {
	methods: {
		helperFindIndex: function helperFindIndex(array, key, lookup) {
			return array.findIndex(function (item) {
				return item[key] == lookup;
			});
		},
		helperMakeNonReactive: function helperMakeNonReactive(collection) {
    ...
    methods: {
        storeDevice: function storeDevice() {
            ...
            this.$http.post(link, this.input).then(function (response) {
                return _this.onStore(response.json());
            }).catch(function (data, status, request) {
                return _this.alertMsg(data.data, 'danger');
            }).bind(this);
        },
        updateDevice: function updateDevice() {
            ...
            this.$http.post(link, this.input).then(function () {
        ...
        onStore: function onStore(newDevice) {
        ...
        alertMsg: function alertMsg(alert, alertClass) {
            ...
            this.alert.messages = (typeof alert === 'undefined' ? 'undefined' : _typeof(alert)) == 'object' ? alert : JSON.parse(alert);

            this.alert.class = alertClass;
            this.show_loader = false;

            setTimeout(function () {
                return _this3.alert.messages = [];
            }, 15000);
        },
...
},{"./components/datepicker.vue":76,"./components/inputText.vue":77,"./components/table.vue":78,"./mixins/atReady":80,"./mixins/helper":81,"moment":69,"vue":74,"vue-resource":72,"vue-spinner/dist/vue-spinner.min.js":73}]},{},[83]);
