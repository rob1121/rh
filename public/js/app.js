...
exports.default = {
	...
	components: { PulseLoader: _vueSpinnerMin.PulseLoader },
...
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "<div class=\"box\"><div id=\"title\"><slot></slot><p class=\"dateTime\">{{ time }}</p></div><div class=\"cards\"><div v-for=\"device in omegas | isOne\" v-bind:class=\"device  | filterClasses\" class=\"card\"><div v-show=\"device.is_recording != 'Off' &amp;&amp; device.is_recording != 'On'\" class=\"card-loader\"><span>Fetching data..</span><pulse-loader loading=\"loading\" color=\"#ffffff\" size=\"15px\"></pulse-loader></div><div class=\"title\"> {{ device.location }}:</div><div class=\"content\"><div class=\"card-content\"><div class=\"name\">RH:</div><div class=\"value\">{{ device.rh | isNull | isUndefined | suffix \"%\"}}</div></div><div class=\"card-content\"><div class=\"name\">TEMP:</div><div class=\"value\">{{ device.temp | isNull | isUndefined | suffix \"&deg;C\"}}</div></div></div><div class=\"card-footer\"><p>recording: {{ device.is_recording | isNull | isUndefined }}</p></div></div></div></div>"
